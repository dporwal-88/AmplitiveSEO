export default function MobileAliceCard() {
  return (
    <div className="flex w-full justify-center items-center overflow-hidden py-4 h-[280px] sm:h-[450px]">
      <div className="origin-center scale-[0.38] sm:scale-[0.5]">
        <div className="relative flex-shrink-0 w-[796px] h-[497px]">
          ...
          >
            <svg width="35" height="35" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M37.8752 22.3807V10.3296C37.8752 9.41637 37.5124 8.54058 36.8667 7.89486C36.221 7.24914 35.3452 6.88638 34.432 6.88638H6.88654C5.97335 6.88638 5.09757 7.24914 4.45184 7.89486C3.80612 8.54058 3.44336 9.41637 3.44336 10.3296V30.9886C3.44336 32.8824 4.99279 34.4318 6.88654 34.4318H20.6593" stroke="url(#paint0_linear_303_14611_mob)" strokeWidth="3.44318" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M37.8752 12.0511L22.4325 21.8642C21.901 22.1972 21.2865 22.3738 20.6593 22.3738C20.0321 22.3738 19.4175 22.1972 18.886 21.8642L3.44336 12.0511" stroke="url(#paint1_linear_303_14611_mob)" strokeWidth="3.44318" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M27.5469 32.7102L30.9901 36.1534L37.8764 29.2671" stroke="url(#paint2_linear_303_14611_mob)" strokeWidth="3.44318" strokeLinecap="round" strokeLinejoin="round" />
              <defs>
                <linearGradient id="paint0_linear_303_14611_mob" x1="37.8752" y1="6.88638" x2="9.76676" y2="40.7519" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FFA9CF" />
                  <stop offset="1" stopColor="#C62943" />
                </linearGradient>
                <linearGradient id="paint1_linear_303_14611_mob" x1="37.8752" y1="12.0511" x2="31.7964" y2="31.5944" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FFA9CF" />
                  <stop offset="1" stopColor="#C62943" />
                </linearGradient>
                <linearGradient id="paint2_linear_303_14611_mob" x1="37.8764" y1="29.2671" x2="31.1867" y2="38.9389" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FFA9CF" />
                  <stop offset="1" stopColor="#C62943" />
                </linearGradient>
              </defs>
          ...
          >
            <svg width="35" height="35" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M33.25 7H8.75C6.817 7 5.25 8.567 5.25 10.5V35C5.25 36.933 6.817 38.5 8.75 38.5H33.25C35.183 38.5 36.75 36.933 36.75 35V10.5C36.75 8.567 35.183 7 33.25 7Z" stroke="url(#paint0_linear_303_14619_mob)" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M28 3.5V10.5" stroke="url(#paint1_linear_303_14619_mob)" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M14 3.5V10.5" stroke="url(#paint2_linear_303_14619_mob)" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M5.25 17.5H36.75" stroke="url(#paint3_linear_303_14619_mob)" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M14 24.5H14.0175" stroke="url(#paint4_linear_303_14619_mob)" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M21 24.5H21.0175" stroke="url(#paint5_linear_303_14619_mob)" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M28 24.5H28.0175" stroke="url(#paint6_linear_303_14619_mob)" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M14 31.5H14.0175" stroke="url(#paint7_linear_303_14619_mob)" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M21 31.5H21.0175" stroke="url(#paint8_linear_303_14619_mob)" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M28 31.5H28.0175" stroke="url(#paint9_linear_303_14619_mob)" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
              <defs>
                <linearGradient id="paint0_linear_303_14619_mob" x1="36.75" y1="7" x2="9.1875" y2="40.4688" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FF8853" />
                  <stop offset="1" stopColor="#FF755F" />
                </linearGradient>
                <linearGradient id="paint1_linear_303_14619_mob" x1="29" y1="3.5" x2="26.8981" y2="3.86462" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FF8853" />
                  <stop offset="1" stopColor="#FF755F" />
                </linearGradient>
                <linearGradient id="paint2_linear_303_14619_mob" x1="15" y1="3.5" x2="12.8981" y2="3.86462" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FF8853" />
                  <stop offset="1" stopColor="#FF755F" />
                </linearGradient>
                <linearGradient id="paint3_linear_303_14619_mob" x1="36.75" y1="17.5" x2="36.7034" y2="19.2819" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FF8853" />
                  <stop offset="1" stopColor="#FF755F" />
                </linearGradient>
                <linearGradient id="paint4_linear_303_14619_mob" x1="14.0175" y1="24.5" x2="13.9796" y2="24.5008" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FF8853" />
                  <stop offset="1" stopColor="#FF755F" />
                </linearGradient>
                <linearGradient id="paint5_linear_303_14619_mob" x1="21.0175" y1="24.5" x2="20.9796" y2="24.5008" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FF8853" />
                  <stop offset="1" stopColor="#FF755F" />
                </linearGradient>
                <linearGradient id="paint6_linear_303_14619_mob" x1="28.0175" y1="24.5" x2="27.9796" y2="24.5008" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FF8853" />
                  <stop offset="1" stopColor="#FF755F" />
                </linearGradient>
                <linearGradient id="paint7_linear_303_14619_mob" x1="14.0175" y1="31.5" x2="13.9796" y2="31.5008" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FF8853" />
                  <stop offset="1" stopColor="#FF755F" />
                </linearGradient>
                <linearGradient id="paint8_linear_303_14619_mob" x1="21.0175" y1="31.5" x2="20.9796" y2="31.5008" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FF8853" />
                  <stop offset="1" stopColor="#FF755F" />
                </linearGradient>
                <linearGradient id="paint9_linear_303_14619_mob" x1="28.0175" y1="31.5" x2="27.9796" y2="31.5008" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FF8853" />
                  <stop offset="1" stopColor="#FF755F" />
                </linearGradient>
              </defs>
          ...
          <div className="absolute top-[80px] shadow-[0_0_30px_rgba(255,255,255,0.25)] left-[140px] w-[520px] h-[340px] z-20 rounded-[20px] border-none">
              ...
              <div className="relative z-10 flex flex-col justify-between h-full text-white font-medium">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-4">
                    {/* Avatar */}
                    <div className="w-14 h-14 rounded-full bg-gradient-to-l from-[#FF8853] to-[#FF5001] flex items-center justify-center font-bold text-white text-[18px] shadow-sm">
                      AD
                    </div>
                    <div className="flex flex-col items-start">
                      <span className="text-[23px] font-medium text-white mb-0.5">Alice Davis</span>
                      <span className="text-[19px] font-light text-white">Company Name</span>
                    </div>
                  </div>
