        ...
        <div className="relative flex-1 w-full flex items-center justify-center  ">
          ...
          <div className="absolute w-[600px] h-[226px] scale-[0.50] sm:scale-[0.65] md:scale-[0.80] lg:scale-[0.95] mt-12 origin-center">
            ...
            <div className="absolute flex items-center gap-2.5 px-4 py-2.5 rounded-full border border-white/10 bg-white/[0.04] backdrop-blur-md shadow-[0_10px_30px_rgba(0,0,0,0.5),inset_1.86px_1.86px_16.73px_0px_rgba(117,186,255,0.12),inset_1.86px_1.86px_16.73px_0px_rgba(91,236,113,0.05)] z-20 scale-[0.65] md:scale-[0.95] -translate-x-8 translate-y-6 md:-translate-x-0 md:translate-y-0"
              ...
              <g clip-path="url(#clip0_303_14986)">
              <path d="M5 18.3333V3.33329C5 3.10829 5 2.87496 5.05833 2.64996C5.10934 2.42548 5.22228 2.21981 5.38431 2.0563C5.54635 1.89279 5.75099 1.77799 5.975 1.72496C6.21667 1.66663 7.275 1.66663 7.5 1.66663H13.3333C13.5583 1.66663 13.7917 1.66663 14.0167 1.72496C14.2411 1.77597 14.4468 1.8889 14.6103 2.05094C14.7738 2.21298 14.8886 2.41762 14.9417 2.64163C15 2.87496 15 3.10829 15 3.33329V18.3333H5Z" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M1.66592 11.6667V16.6667C1.66592 17.5833 2.41592 18.3333 3.33258 18.3333H4.99925V10H3.33258C3.10758 10 2.87425 10 2.64925 10.0583C2.42425 10.1167 2.21592 10.225 2.04925 10.3917C1.89092 10.55 1.78258 10.7583 1.72425 10.9833C1.67721 11.2079 1.65762 11.4374 1.66592 11.6667Z" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M17.35 7.55835C17.1254 7.51131 16.896 7.49173 16.6667 7.50002H15V18.3334H16.6667C17.1087 18.3334 17.5326 18.1578 17.8452 17.8452C18.1577 17.5326 18.3333 17.1087 18.3333 16.6667V9.16669C18.3333 8.93336 18.3333 8.70836 18.275 8.48336C18.2167 8.25836 18.1083 8.05002 17.9417 7.88336C17.7833 7.72502 17.575 7.61669 17.35 7.55835Z" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M8.33594 5H11.6693" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M8.33594 8.33337H11.6693" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M8.33594 11.6666H11.6693" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M8.33594 15H11.6693" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
              </g>
              <defs>
            ...
            <div className="absolute flex items-center gap-2.5 px-4 py-2.5 rounded-full border border-white/10 bg-white/[0.04] backdrop-blur-md shadow-[0_10px_30px_rgba(0,0,0,0.5),inset_1.86px_1.86px_16.73px_0px_rgba(117,186,255,0.12),inset_1.86px_1.86px_16.73px_0px_rgba(91,236,113,0.05)] z-20 scale-[0.75] md:scale-[0.95] -translate-y-9 md: translate-0"
                 style={{ left: "280px", top: "190px", transform: "translate(-50%, -50%)" }}>
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M15.8307 17.5V15.8333C15.8307 14.9493 15.4795 14.1014 14.8544 13.4763C14.2293 12.8512 13.3815 12.5 12.4974 12.5H7.4974C6.61334 12.5 5.76549 12.8512 5.14037 13.4763C4.51525 14.1014 4.16406 14.9493 4.16406 15.8333V17.5" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M9.9974 9.16667C11.8383 9.16667 13.3307 7.67428 13.3307 5.83333C13.3307 3.99238 11.8383 2.5 9.9974 2.5C8.15645 2.5 6.66406 3.99238 6.66406 5.83333C6.66406 7.67428 8.15645 9.16667 9.9974 9.16667Z" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            ...
            {/* 3. The 4 Circular Nodes along the curve */}
            
            {/* Node 1: Chat (Pink) */}
            <div className="absolute w-[75px] h-[75px] rounded-full shadow-[0_0_20px_rgba(0,0,0,0.6)] z-30" 
                 style={{ left: "90px", top: "130px", transform: "translate(-50%, -50%)" ,boxShadow:
            ...
            {/* Node 2: Bell (Green) */}
            <div className="absolute w-[75px] h-[75px] rounded-full shadow-[0_0_20px_rgba(0,0,0,0.6)] z-30" 
                 style={{ left: "220px", top: "75px", transform: "translate(-50%, -50%)" ,boxShadow:
                "0 0 0 10px rgba(255, 255, 255, 0.08), 0 10px 20px rgba(0, 0, 0, 0.2)"}}>
            ...
            <div className="absolute w-[75px] h-[75px] rounded-full shadow-[0_0_20px_rgba(0,0,0,0.6)] z-30" 
                 style={{ left: "380px", top: "75px", transform: "translate(-50%, -50%)" ,boxShadow:
                "0 0 0 10px rgba(255, 255, 255, 0.08), 0 10px 20px rgba(0, 0, 0, 0.2)"}}>
            ...
            <div className="absolute w-[75px] h-[75px] rounded-full shadow-[0_0_20px_rgba(0,0,0,0.6)] z-30" 
                 style={{ left: "520px", top: "130px", transform: "translate(-50%, -50%)" ,boxShadow:
                "0 0 0 10px rgba(255, 255, 255, 0.08), 0 10px 20px rgba(0, 0, 0, 0.2)"}}>
