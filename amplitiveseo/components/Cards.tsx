            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <div className="relative flex-1 w-full mt-2">
                ...
                <div className="absolute inset-0 top-[-18px]">
                  ...
                  {/* Node 1 */}
                  <div
                    className="absolute w-[14px] h-[14px] bg-[#5BEC71]/20 rounded-full flex items-center justify-center shadow-lg"
                    style={{
                      left: "13.5%",
                      bottom: "47%",
                  ...
                  {/* Node 3 */}
                  <div
                    className="absolute w-[14px] h-[14px] bg-[#3ab4aa]/20 rounded-full flex items-center justify-center shadow-lg"
                    style={{
                      left: "50.5%",
                      bottom: "75%",
                      transform: "translate(-50%, 50%)",
                  ...
                  {/* Node 5 */}
                  <div
                    className="absolute w-[14px] h-[14px] bg-[#00A3FF]/20 rounded-full flex items-center justify-center shadow-lg"
                    style={{
                      left: "86.5%",
                      bottom: "79%",
                      transform: "translate(-50%, 50%)",
