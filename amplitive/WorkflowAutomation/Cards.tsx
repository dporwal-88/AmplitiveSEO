        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8">
            ...
            <div className="relative z-10 flex flex-col h-full">
                ...
                icon={
                  ...
                  >
                    <rect
                      ...
                      height="38"
                      rx="5.4"
                      fill="url(#paint0_linear_425_1591)"
                    />
                    <g clip-path="url(#clip0_425_1591)">
                      <path
                      ...
                      />
                      <path
                        d="M27.332 22.3334H22.332V27.3334H27.332V22.3334Z"
                        stroke="white"
                        stroke-width="1.66667"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
                      <path
                        d="M15.668 22.3334H10.668V27.3334H15.668V22.3334Z"
                        stroke="white"
                        stroke-width="1.66667"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
                      <path
                        d="M13.168 22.3333V19H24.8346V22.3333"
                        stroke="white"
                        stroke-width="1.66667"
                        stroke-linecap="round"
                        stroke-linejoin="round"
              ...
              <div className="relative top-4 flex-1 w-full flex items-center justify-center">
                <div className="absolute w-[600px] h-[300px] scale-[0.54] sm:scale-[0.65] md:scale-[0.55] lg:scale-[0.75] xl:scale-[0.85] origin-center translate-y-1 md:-translate-y-4">
                  {/* Top Center Card */}
                  <div
                    className="absolute scale-[0.5] top-0 left-1/2 -translate-x-1/2 w-[340px] bg-white rounded-[12px] p-4 shadow-[0_0_0_10px_rgba(255,255,255,0.08),0_10px_20px_rgba(0,0,0,0.2)] z-30 transition-transform hover:-translate-y-1"
                  >
                    <div className="flex gap-3 items-start">
                      ...
                      >
                        ...
                        <rect
                          ...
                          height="15.1053"
                          rx="2.13158"
                          fill="url(#paint0_linear_425_1600)"
                          fill-opacity="0.92"
                        />
                        <g clip-path="url(#clip0_425_1600)">
                          <path
                            d="M8.38281 4.21924H5.54948C5.37267 4.21924 5.2031 4.28948 5.07807 4.4145C4.95305 4.53952 4.88281 4.70909 4.88281 4.8859V10.2192C4.88281 10.396 4.95305 10.5656 5.07807 10.6906C5.2031 10.8157 5.37267 10.8859 5.54948 10.8859H9.54948C9.72629 10.8859 9.89586 10.8157 10.0209 10.6906C10.1459 10.5656 10.2161 10.396 10.2161 10.2192V6.05257L8.38281 4.21924Z"
                            stroke="#0F72D7"
                          ...
                          />
                          <path
                            d="M8.21875 4.21924V6.21924H10.2188"
                            stroke="#0F72D7"
                            stroke-width="0.666667"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        ...
                        <defs>
                          ...
                          <clipPath id="clip0_425_1600">
                            <rect
                              ...
                              height="8"
                              fill="white"
                              transform="translate(3.55078 3.55261)"
                            />
                          </clipPath>
                        </defs>
                      </svg>
                      <h4 className="text-[14px] text-[#01091E] mb-1">
                        Two Week Content Batch
                      </h4>
                    ...
                    <div className="flex flex-col items-start w-[70%]">
                      <p className="text-[12px] text-gray-500 leading-[1.3] mb-3">
                        ...
                        tweaks, image generation, and automated HubSpot
                        creation.
                      </p>
                        ...
                        <span className="text-[9px] font-semibold text-blue-600 bg-blue-50 px-2 py-0.5 rounded flex items-center gap-1">
                          <span className="w-1.5 h-1.5 ">
                            <svg width="7" height="7" viewBox="0 0 7 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <g clip-path="url(#clip0_425_1606)">
                              <path d="M3.4987 0.583374L4.39995 2.40921L6.41536 2.70379L4.95703 4.12421L5.3012 6.13087L3.4987 5.18296L1.6962 6.13087L2.04036 4.12421L0.582031 2.70379L2.59745 2.40921L3.4987 0.583374Z" stroke="#0F72D7" stroke-width="0.583333" stroke-linecap="round" stroke-linejoin="round"/>
                              </g>
                              <defs>
                  ...
                  {/* Bottom Left Card */}
                  <div
                    className="absolute bottom-1 scale-[0.5] left-[20px] w-[340px] bg-white rounded-[12px] p-4 shadow-[0_0_0_10px_rgba(255,255,255,0.08),0_10px_20px_rgba(0,0,0,0.2)] z-20 transition-transform hover:-translate-y-1"
                  >
                    <div className="flex gap-3 items-start">
                      <div className="w-10 h-10 rounded-lgflex items-center justify-center shrink-0">
                        <svg width="25" height="25" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="15.1053" height="15.1053" rx="2.13158" fill="white"/>
                        <rect width="15.1053" height="15.1053" rx="2.13158" fill="url(#paint0_linear_425_1617)" fill-opacity="0.5"/>
                        <g clip-path="url(#clip0_425_1617)">
                        <path d="M8.88542 10.5526V9.88595C8.88542 9.53232 8.74494 9.19319 8.49489 8.94314C8.24484 8.69309 7.90571 8.55261 7.55208 8.55261H5.55208C5.19846 8.55261 4.85932 8.69309 4.60927 8.94314C4.35923 9.19319 4.21875 9.53232 4.21875 9.88595V10.5526" stroke="#FF8853" stroke-width="0.666667" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M6.55208 7.21928C7.28846 7.21928 7.88542 6.62233 7.88542 5.88595C7.88542 5.14957 7.28846 4.55261 6.55208 4.55261C5.8157 4.55261 5.21875 5.14957 5.21875 5.88595C5.21875 6.62233 5.8157 7.21928 6.55208 7.21928Z" stroke="#FF8853" stroke-width="0.666667" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M10.8828 10.5526V9.88595C10.8826 9.59052 10.7843 9.30354 10.6033 9.07005C10.4223 8.83657 10.1689 8.6698 9.88281 8.59595" stroke="#FF8853" stroke-width="0.666667" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M8.88281 4.59595C9.16962 4.66938 9.42382 4.83618 9.60536 5.07005C9.78689 5.30392 9.88543 5.59156 9.88543 5.88761C9.88543 6.18367 9.78689 6.47131 9.60536 6.70518C9.42382 6.93905 9.16962 7.10585 8.88281 7.17928" stroke="#FF8853" stroke-width="0.666667" stroke-linecap="round" stroke-linejoin="round"/>
                        </g>
                        <defs>
                        <linearGradient id="paint0_linear_425_1617" x1="11.3289" y1="0" x2="3.14943" y2="20.2601" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FFDDBC" stop-opacity="0.43"/>
                    ...
                    <div className="flex-1 w-[80%]">
                        ...
                        <span className="text-[9px] font-semibold text-[#7D7D7D] bg-white px-2 py-0.5 rounded">
                          8 Nodes
                        </span>
                      </div>
                  ...
                  {/* Bottom Right Card */}
                  <div
                    className="absolute scale-[0.57] bottom-2 right-[20px] w-[340px] bg-white rounded-[12px] p-4 shadow-[0_0_0_10px_rgba(255,255,255,0.08),0_10px_20px_rgba(0,0,0,0.2)] z-20 transition-transform hover:-translate-y-1"
                  >
                    <div className="flex gap-3 items-start">
                    ...
                    <div className="flex-1 w-[80%]">
                        ...
                        <span className="text-[9px] font-semibold text-[#7D7D7D] bg-[#F5F5F5] px-2 py-0.5 rounded">
                          7 Nodes
                        </span>
                      </div>
                    <button className="absolute top-[45%] right-4 bg-[#0A1325] text-white text-[11px] font-medium px-2 py-1 rounded-[6px] hover:bg-gray-800 transition-colors">
              ...
              <div className="relative flex-1 w-full flex items-center justify-center">
                <div className="absolute md:bottom-[-25px] w-[500px] h-[320px] scale-[0.56] sm:scale-[0.65] md:scale-[0.6] lg:scale-[0.75] xl:scale-[0.85] origin-center translate-x-8 md:translate-x-0 translate-y-4">
                  ...
                  <div className="absolute inset-0 w-full h-full pointer-events-none z-0">
                    ...
                    {/* Add Step -> Trigger Manually (Top Curve) */}
                    ...
                    {/* Add Step -> On a Schedule (Middle Line) */}
                  ...
                  {/* Add Step Box */}
                  <div className="absolute top-[115px] left-0 w-[87px] h-[90px] bg-[#FFFFFF1A] border-[2px] border-dashed border-[#FFFFFFCC] rounded-[12px] flex flex-col items-center justify-center z-20 cursor-pointer shadow-[0_0_20px_rgba(91,236,113,0.1)] backdrop-blur-sm">
                    <span className="text-[#FFFFFF] text-[24px] font-light mb-1 leading-none">
                      +
                    </span>
                    <span className="text-[#FFFFFF] text-[14px] font-medium tracking-wide">
                      Add Step
                    </span>
                  </div>

                  {/* Top Node */}
                  <div className="absolute top-[25px] scale-[0.95] left-[170px] w-[210px] h-[62px] bg-[#0A1325]/80 border border-[#FFFFFF1A] rounded-[12.55px] shadow-[inset_5.02px_5.02px_45.17px_0px_#75BAFF1F,inset_5.02px_5.02px_45.17px_0px_#5BEC710D,0px_5.02px_22.59px_0px_#75BAFF1F] backdrop-blur-[12.55px] flex items-center px-[16px] py-[12px] z-20">
                    <div className="w-10 h-10 rounded-[10px]  flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(91,236,113,0.4)]">
                      <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="39.8216" height="39.8216" rx="7.51397" fill="url(#paint0_linear_425_1673)"/>
                        <path d="M13.0742 13.0774L19.1132 27.5982L21.2571 21.2859L27.5951 19.1164L13.0742 13.0774Z" stroke="white" stroke-width="1.70833" stroke-linecap="round" stroke-linejoin="round"/>
                        <defs>
                  ...
                  {/* Middle Node */}
                  <div className="absolute top-[125px] scale-[0.95] left-[220px] w-[210px] h-[62px] bg-[#0A1325]/80 border border-[#FFFFFF1A] rounded-[12.55px] shadow-[inset_5.02px_5.02px_45.17px_0px_#75BAFF1F,inset_5.02px_5.02px_45.17px_0px_#5BEC710D,0px_5.02px_22.59px_0px_#75BAFF1F] backdrop-blur-[12.55px] flex items-center px-[16px] py-[12px] z-20">
                    ...
                    <path d="M19.9089 28.4525C24.6263 28.4525 28.4505 24.6282 28.4505 19.9108C28.4505 15.1934 24.6263 11.3691 19.9089 11.3691C15.1914 11.3691 11.3672 15.1934 11.3672 19.9108C11.3672 24.6282 15.1914 28.4525 19.9089 28.4525Z" stroke="white" stroke-width="1.70833" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M19.9102 14.7858V19.9108L23.3268 21.6191" stroke="white" stroke-width="1.70833" stroke-linecap="round" stroke-linejoin="round"/>
                    <defs>
                    ...
                    <stop offset="1" stop-color="#A05CFA"/>
                    </linearGradient>
                    </defs>
                    </svg>
                    </div>
                  ...
                  {/* Bottom Node */}
                  <div className="absolute top-[225px] scale-[0.95] left-[170px] w-[210px] h-[62px] bg-[#0A1325]/80 border border-[#FFFFFF1A] rounded-[12.55px] shadow-[inset_5.02px_5.02px_45.17px_0px_#75BAFF1F,inset_5.02px_5.02px_45.17px_0px_#5BEC710D,0px_5.02px_22.59px_0px_#75BAFF1F] backdrop-blur-[12.55px] flex items-center px-[16px] py-[12px] z-20">
                    <div className="w-10 h-10 rounded-[10px] bg-gradient-to-br from-[#73B4FF] to-[#3B82F6] flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(59,130,246,0.4)]">
                      ...
                      <path d="M13.9492 17.3776V23.3796" stroke="white" stroke-width="1.60054" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M14.1617 16.9488C15.7007 16.9488 16.9483 15.7012 16.9483 14.1621C16.9483 12.6231 15.7007 11.3755 14.1617 11.3755C12.6226 11.3755 11.375 12.6231 11.375 14.1621C11.375 15.7012 12.6226 16.9488 14.1617 16.9488Z" stroke="white" stroke-width="1.60054" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M13.9473 28.5241C15.3679 28.5241 16.5196 27.3725 16.5196 25.9518C16.5196 24.5312 15.3679 23.3795 13.9473 23.3795C12.5267 23.3795 11.375 24.5312 11.375 25.9518C11.375 27.3725 12.5267 28.5241 13.9473 28.5241Z" stroke="white" stroke-width="1.60054" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M25.9512 28.5241C27.3718 28.5241 28.5235 27.3725 28.5235 25.9518C28.5235 24.5312 27.3718 23.3795 25.9512 23.3795C24.5306 23.3795 23.3789 24.5312 23.3789 25.9518C23.3789 27.3725 24.5306 28.5241 25.9512 28.5241Z" stroke="white" stroke-width="1.60054" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M14.0586 17.3776C14.4444 18.8781 15.8163 19.9927 17.4369 19.9842L20.3779 19.9756C22.6243 19.967 24.5364 21.4075 25.2395 23.4139" stroke="white" stroke-width="1.60054" stroke-linecap="round" stroke-linejoin="round"/>
                      <defs>
          ...
          <FeatureCard className="h-[235px] md:h-[420px] lg:h-[380px]">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              />
              <p className="text-[13px] md:text-[11.95px] text-white/80 leading-[1.2] md:leading-[1.4] mb-6 mt-1">
              ...
              <div className="relative flex-1 w-full flex items-center justify-center">
                <div className="absolute w-[500px] h-[300px] scale-[0.43] sm:scale-[0.65] md:scale-[0.6] lg:scale-[0.75] xl:scale-[0.9] origin-center -translate-y-2">
                  ...
                  {/* Top Left Card (Gmail) */}
                  <div
                    className="absolute top-[35px] shadow-[0_0_0_5px_rgba(255,255,255,0.08),0_5px_10px_rgba(0,0,0,0.2)] scale-[0.7] left-[-10px] w-[230px] bg-white rounded-[8px] px-4 py-[14px] z-20"
                  >
                  ...
                  <div className="absolute top-[110px] left-[210px] w-[80px] h-[80px] z-20 flex items-center justify-center">
                    ...
                    <div className="relative w-14 h-14 rounded-full  flex items-center justify-center z-30">
                      <div className="w-10 h-10 rounded-full flex items-center justify-center">
                        {/* Sitemap/Hierarchy Icon matching Figma */}
                        <svg width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="50.914" height="50.914" rx="25.457" fill="url(#paint0_linear_425_1739)"/>
                        <path d="M28.3482 15.8152H22.5625V21.6009H28.3482V15.8152Z" stroke="white" stroke-width="1.92856" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M35.0982 29.3152H29.3125V35.1009H35.0982V29.3152Z" stroke="white" stroke-width="1.92856" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M21.5982 29.3152H15.8125V35.1009H21.5982V29.3152Z" stroke="white" stroke-width="1.92856" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M18.7031 29.3151V25.458H32.2031V29.3151" stroke="white" stroke-width="1.92856" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M25.4531 25.4582V21.6011" stroke="white" stroke-width="1.92856" stroke-linecap="round" stroke-linejoin="round"/>
                        <defs>
                  ...
                  <div
                    className="absolute scale-[0.7] shadow-[0_0_0_5px_rgba(255,255,255,0.08),0_5px_10px_rgba(0,0,0,0.2)] top-[215px] left-[245px] w-[255px] bg-white rounded-[12px] px-4 py-[14px] z-20"
                  >
            ...
            <div className="absolute -bottom-20 -right-20 pointer-events-none z-0 opacity-40">
              ...
              >
                <g opacity="0.2" filter="url(#filter0_f_303_14675_4)">
                  <path
                    d="M667.947 373C667.947 516.042 551.989 632 408.947 632C265.906 632 149.947 516.042 149.947 373C149.947 229.958 265.906 114 408.947 114C551.989 114 667.947 229.958 667.947 373Z"
                    fill="url(#paint0_radial_303_14675_4)"
                  />
                </g>
                <defs>
                  <filter
                    id="filter0_f_303_14675_4"
                    x="-9.15527e-05"
                    y="-35.9474"
                    width="817.895"
                    height="817.895"
                  ...
                  >
                    ...
                    <feGaussianBlur
                      stdDeviation="74.9737"
                      result="effect1_foregroundBlur_303_14675_4"
                    />
                  </filter>
                  <radialGradient
                    id="paint0_radial_303_14675_4"
                    cx="0"
                    cy="0"
                    r="1"
                    gradientUnits="userSpaceOnUse"
                ...
                icon={
                  ...
                  >
                    <rect
                      ...
                      height="38"
                      rx="5.4"
                      fill="url(#paint0_linear_425_1766)"
                    />
                    <path
                      d="M23.168 10.6666L26.5013 14L23.168 17.3333"
                      stroke="white"
                      stroke-width="1.66667"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M11.5 18.1667V17.3333C11.5 16.4493 11.8512 15.6014 12.4763 14.9763C13.1014 14.3512 13.9493 14 14.8333 14H26.5"
                      stroke="white"
                      stroke-width="1.66667"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M14.8333 27.3333L11.5 24L14.8333 20.6666"
                      stroke="white"
                      stroke-width="1.66667"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M26.5 19.8334V20.6667C26.5 21.5508 26.1488 22.3986 25.5237 23.0237C24.8986 23.6489 24.0507 24 23.1667 24H11.5"
                      stroke="white"
                      stroke-width="1.66667"
                      stroke-linecap="round"
                      stroke-linejoin="round"
              ...
              <div className="relative top-[30px] flex-1 w-full flex items-center justify-center">
                <div className="absolute w-[500px] h-[260px] scale-[0.5] sm:scale-[0.65] md:scale-[0.6] lg:scale-[0.75] xl:scale-[0.9] origin-center -translate-y-4 flex flex-col gap-10">
                  ...
                  <div className="flex justify-center w-full px-6">
                    {/* Save Time */}
                    <div
                      className="w-[210px] scale-[0.78] rounded-[12px] p-4 flex items-center shadow-[0_0_0_5px_rgba(255,255,255,0.08),0_5px_10px_rgba(0,0,0,0.2)] gap-1.5 transition-transform hover:-translate-y-1"
                      style={{
                        background: "linear-gradient(60.63deg, rgba(185, 205, 255, 0.35) -8.01%, rgba(238, 233, 255, 0.35) 90.19%), #FFFFFF"
                      }}
                    >
                      ...
                      <div className="flex flex-col">
                        <span className="text-[15px] text-[#3E3E3E] leading-tight">
                          Save Time
                        </span>
                    ...
                    {/* Reduce Errors */}
                    <div
                      className="w-[210px] scale-[0.78] rounded-[12px] p-4 shadow-[0_0_0_5px_rgba(255,255,255,0.08),0_5px_10px_rgba(0,0,0,0.2)] flex items-center gap-3 transition-transform hover:-translate-y-1"
                      style={{
                        background: "linear-gradient(201.99deg, rgba(255, 221, 188, 0.1505) 7.19%, rgba(255, 160, 118, 0.35) 118.31%), #FFFFFF"
                      }}
                    >
                      <div className="w-10 h-10 rounded-[10px] flex items-center justify-center shrink-0">
                        <svg width="32" height="32" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="flex flex-col">
                        <span className="text-[15px] text-[#01091E] leading-tight">
                          Reduce Errors
                        </span>
                        <span className="text-[11px] text-gray-500 mt-1 leading-tight">
                  ...
                  <div className="flex justify-between w-full px-2 md:px-5">
                    {/* Improve Handoffs */}
                  <div
                    className="w-[210px] scale-[0.8] rounded-[12px] p-4 shadow-[0_0_0_5px_rgba(255,255,255,0.08),0_5px_10px_rgba(0,0,0,0.2)] flex items-center gap-3 transition-transform hover:-translate-y-1"
                    style={{
                      background: "linear-gradient(201.99deg, rgba(239, 247, 255, 0.4) 7.19%, rgba(165, 201, 255, 0.4) 118.31%), #FFFFFF"
                    }}
                  >
                    <div className="w-10 h-10 rounded-[10px] flex items-center justify-center shrink-0">
                      <svg width="32" height="32" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex flex-col">
                      <span className="text-[14.5px] text-[#01091E] leading-tight">
                        Improve Handoffs
                      </span>
                      <span className="text-[11px] text-gray-500 mt-1 leading-tight">
                  ...
                  <div
                    className="w-[210px] scale-[0.8] rounded-[12px] p-4 shadow-[0_0_0_5px_rgba(255,255,255,0.08),0_5px_10px_rgba(0,0,0,0.2)] flex items-center gap-3 transition-transform hover:-translate-y-1"
                    style={{
                      background: "linear-gradient(60.63deg, rgba(255, 183, 183, 0.35) -8.01%, rgba(255, 234, 243, 0.35) 90.19%), #FFFFFF"
                    }}
                  >
                    <div className="w-10 h-10 rounded-[10px] flex items-center justify-center shrink-0">
                      <svg width="32" height="32" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[11px] text-gray-500 mt-1 leading-tight">
                        Standardized processes that grow with you
                      </span>
                    </div>
                  </div>
                  </div>
