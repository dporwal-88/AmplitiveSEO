                  ...
                  <div className="w-full h-full flex flex-col gap-[16.92px] bg-[#FFFFFF0F] border border-white/10 rounded-[11.63px] p-[23.26px] shadow-[inset_2.11px_2.11px_19.03px_0px_#75BAFF1F,inset_2.11px_2.11px_19.03px_0px_#5BEC710D,0_4.23px_33.84px_rgba(117,186,255,0.16)] backdrop-blur-xl">
                    ...
                    <div className="bg-white rounded-[12px] p-3 flex flex-col justify-between h-full shadow-lg transition-transform hover:-translate-y-1">
                        ...
                        <div className="w-4 h-4 rounded bg-gradient-to-bl from-[#B6DAFF] to-[#63A2FF] flex items-center justify-center">
                            <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_425_36159)">
                                <path d="M3.70155 6.78554C5.40499 6.78554 6.78591 5.40463 6.78591 3.70118C6.78591 1.99774 5.40499 0.616821 3.70155 0.616821C1.9981 0.616821 0.617188 1.99774 0.617188 3.70118C0.617188 5.40463 1.9981 6.78554 3.70155 6.78554Z" stroke="white" stroke-width="0.616872" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M3.70312 1.85059V3.7012L4.93687 4.31807" stroke="white" stroke-width="0.616872" stroke-linecap="round" stroke-linejoin="round"/>
                                </g>
                                <defs>
                    ...
                    <div className="bg-white rounded-[12px] p-3 flex flex-col justify-between h-full shadow-lg transition-transform hover:-translate-y-1">
                        ...
                        <div className="w-4 h-4 rounded bg-gradient-to-bl from-[#BBFFC5] to-[#46C95A] flex items-center justify-center">
                            <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_425_36173)">
                            <path d="M3.70155 6.78554C5.40504 6.78554 6.78591 5.40467 6.78591 3.70118C6.78591 1.99769 5.40504 0.616821 3.70155 0.616821C1.99806 0.616821 0.617188 1.99769 0.617188 3.70118C0.617188 5.40467 1.99806 6.78554 3.70155 6.78554Z" stroke="white" stroke-width="0.616872" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M2.77734 3.70122L3.39422 4.31809L4.62796 3.08435" stroke="white" stroke-width="0.616872" stroke-linecap="round" stroke-linejoin="round"/>
                            </g>
                            <defs>
                    ...
                    <div className="bg-white rounded-[12px] p-3 flex flex-col justify-between h-full shadow-lg transition-transform hover:-translate-y-1">
                        ...
                        <div className="w-4 h-4 rounded bg-gradient-to-bl from-[#FFCC9C] to-[#FF8853] flex items-center justify-center">
                            <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_425_36187)">
                            <path d="M5.86076 1.23376H1.54265C1.20196 1.23376 0.925781 1.50995 0.925781 1.85064V6.16874C0.925781 6.50943 1.20196 6.78561 1.54265 6.78561H5.86076C6.20145 6.78561 6.47763 6.50943 6.47763 6.16874V1.85064C6.47763 1.50995 6.20145 1.23376 5.86076 1.23376Z" stroke="white" stroke-width="0.616872" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M4.93359 0.616821V1.85057" stroke="white" stroke-width="0.616872" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M2.46875 0.616821V1.85057" stroke="white" stroke-width="0.616872" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M0.925781 3.08435H6.47763" stroke="white" stroke-width="0.616872" stroke-linecap="round" stroke-linejoin="round"/>
                            </g>
                            <defs>
              ...
              <CardHeader
                icon={
                  <div className="w-full h-full bg-gradient-to-br from-[#CCFFD4] to-[#2EB0D7] rounded-[4px] scale-[0.85] md:scale-[1] flex items-center justify-center shadow-[0_0_15px_rgba(72,219,251,0.3)]">
                    ...
                    <path d="M13.332 1.66663V4.99996" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M6.66797 1.66663V4.99996" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <div className="relative z-10 flex flex-col h-full pointer-events-none">
            <CardHeader
              icon={
                <div className="w-full h-full bg-gradient-to-br from-[#FFCC9C] to-[#FF8853] rounded-[4px] scale-[0.85] md:scale-[1] flex items-center justify-center shadow-[0_0_15px_rgba(255,159,67,0.3)]">
                  ...
                  <path d="M10 12.5C11.3807 12.5 12.5 11.3807 12.5 10C12.5 8.61929 11.3807 7.5 10 7.5C8.61929 7.5 7.5 8.61929 7.5 10C7.5 11.3807 8.61929 12.5 10 12.5Z" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </div>
              }
            ...
            <div className="absolute bottom-[-30px] left-1/2 -translate-x-1/2 w-[600px] h-[300px] scale-[0.46] sm:scale-[0.55] md:scale-[0.7] lg:scale-100 origin-bottom flex items-end justify-center pointer-events-none">
              ...
              <div className="absolute top-[90px] md:top-[50px] md:left-[110px] bg-[#FFFFFF] rounded-full px-[9px] py-[5px] flex items-center gap-[10px] shadow-[0_10px_20px_rgba(0,0,0,0.2),0_0_20px_rgba(255,255,255,0.2)] ">
                ...
                <path d="M13.1366 4.37842L5.10959 12.4054L1.46094 8.7568" stroke="#3AC750" stroke-width="1.45946" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M16.0558 7.29724L10.5829 12.7702L9.48828 11.6756" stroke="#3AC750" stroke-width="1.45946" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              ...
              <div className="absolute top-[170px] left-[420px] md:top-[132px] md:left-1/2 -translate-x-1/2 bg-[#FFFFFF] rounded-full scale-[0.95] px-[9px] py-[5px] flex items-center gap-[10px] shadow-[0_10px_20px_rgba(0,0,0,0.2),0_0_20px_rgba(255,255,255,0.2)]">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.0244 2.21436H3.69103C2.87576 2.21436 2.21484 2.87527 2.21484 3.69055V14.0239C2.21484 14.8392 2.87576 15.5001 3.69103 15.5001H14.0244C14.8396 15.5001 15.5006 14.8392 15.5006 14.0239V3.69055C15.5006 2.87527 14.8396 2.21436 14.0244 2.21436Z" stroke="#DC486D" stroke-width="1.47619" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M6.64416 8.11901C7.45944 8.11901 8.12035 7.45809 8.12035 6.64282C8.12035 5.82754 7.45944 5.16663 6.64416 5.16663C5.82888 5.16663 5.16797 5.82754 5.16797 6.64282C5.16797 7.45809 5.82888 8.11901 6.64416 8.11901Z" stroke="#DC486D" stroke-width="1.47619" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M15.4972 11.0714L13.2194 8.79366C12.9426 8.51692 12.5672 8.36145 12.1758 8.36145C11.7843 8.36145 11.4089 8.51692 11.1321 8.79366L4.42578 15.5" stroke="#DC486D" stroke-width="1.47619" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              ...
              <div className="absolute bottom-[35px] left-[210px] md:bottom-[75px] md:left-[110px]">
                ...
                <div className="relative w-[38px] h-[38px] bg-gradient-to-br from-[#B6DAFF] to-[#63A2FF] rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(59,130,246,0.5)]">
                  ...
                  <path d="M10.668 1.33325V3.99992" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M5.33203 1.33325V3.99992" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M2 6.66663H14" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M5.33203 9.33325H5.3387" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M8 9.33337H8.00667" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M10.668 9.33325H10.6746" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M5.33203 12H5.3387" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M8 12H8.00667" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M10.668 12H10.6746" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </div>
              </div>
              ...
              <div className="absolute bottom-[-40px] md:bottom-[20px] right-[175px]">
                ...
                <div className="relative w-[38px] h-[38px] bg-gradient-to-br from-[#B8A4FF] to-[#6B31B6] rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(126,34,206,0.5)]">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_425_36555)">
                  <path d="M12 5.33325C12 4.27239 11.5786 3.25497 10.8284 2.50482C10.0783 1.75468 9.06087 1.33325 8 1.33325C6.93913 1.33325 5.92172 1.75468 5.17157 2.50482C4.42143 3.25497 4 4.27239 4 5.33325C4 9.99992 2 11.3333 2 11.3333H14C14 11.3333 12 9.99992 12 5.33325Z" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M9.15432 14C9.03712 14.2021 8.86888 14.3698 8.66647 14.4864C8.46406 14.6029 8.23458 14.6643 8.00099 14.6643C7.7674 14.6643 7.53792 14.6029 7.33551 14.4864C7.13309 14.3698 6.96486 14.2021 6.84766 14" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M1.33203 5.33325C1.33203 3.86659 1.7987 2.46659 2.66536 1.33325" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M14.6654 5.33325C14.6654 3.89078 14.1975 2.48723 13.332 1.33325" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                  </g>
                  <defs>
...
// Shared Component for Background SVGs to keep the main tree clean
    ...
    <>
      <div className="absolute -bottom-20 -right-20 pointer-events-none z-0 opacity-40">
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g opacity="0.2" filter={`url(#filter0_f_card_bg_${index})`}>
            <path
              ...
              fill={`url(#paint0_radial_card_bg_${index})`}
            />
          </g>
          <defs>
            <filter
              id={`filter0_f_card_bg_${index}`}
              x="-9.15527e-05"
              y="-35.9474"
              width="817.895"
              height="817.895"
            ...
            >
              ...
              <feGaussianBlur
                ...
                result={`effect1_foregroundBlur_card_bg_${index}`}
              />
            </filter>
            <radialGradient
              id={`paint0_radial_card_bg_${index}`}
              cx="0"
              cy="0"
              r="1"
